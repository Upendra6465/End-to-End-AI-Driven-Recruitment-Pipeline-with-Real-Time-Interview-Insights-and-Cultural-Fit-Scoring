...
os.environ["TOGETHER_API_KEY"] = "d508a94fbfa184d49ded783bb12d8eff3510d94714904a4d58b653be84498391"  # Replace with your actual API key
client = Together()

# Define candidate roles and descriptions
roles_skills = {
    "Data Scientist": {
        "description": "Analyze data, build predictive models, and communicate insights."
    },
    "Data Engineer": {
        "description": "Design and maintain data pipelines for scalable data processing."
    },
    "Software Engineer": {
        "description": "Develop and maintain software solutions and optimize performance."
    },
    "Product Manager": {
        "description": "Define product vision, strategy, and manage cross-functional teams."
    },
    "UI Engineer": {
...
for i in range(1, 501):  # Generate n no.of records
